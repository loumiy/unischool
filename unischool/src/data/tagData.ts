...
export const TAGS: readonly TagDef[] = [
  ...
  { id: 'country-club', name: 'Country Club', blurb: 'Beautiful grounds, a long waiting list, and a lot of sailing.', why: 'A dear sticker, little aid, and a beautiful campus.', size: -0.05, quality: 2, teeth: { lever: 'giving', amount: 0.15, line: 'Old money writes checks: fifteen percent more giving each year.' } },
  ...
  { id: 'the-bargain', name: 'The Bargain', blurb: 'A good degree at a price a family can say out loud.', why: 'A net price well under the market\'s, for a respectable class.', size: 0.12, quality: -1, teeth: { lever: 'pool', amount: 0.04, line: 'Families say yes: four percent more apply.' } },
  { id: 'old-money', name: 'Old Money', blurb: 'Endowed before anyone alive was born, and dressed for it.', why: 'A large endowment, held a long time.', size: 0.06, quality: 3, teeth: { lever: 'pool', amount: 0.03, line: 'A name that opens doors: three percent more apply.' } },
];
