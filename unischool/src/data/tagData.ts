...
export const TAGS: readonly TagDef[] = [
  ...
  { id: 'artsy', name: 'Artsy', blurb: 'Studios open all night and a gallery in every stairwell.', why: 'The arts: their programmes, their buildings, their share of the campus.', size: -0.03, quality: 1, teeth: { lever: 'beauty', amount: 5, line: 'Studios and galleries everywhere: five points of campus beauty.' } },
