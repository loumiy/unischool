...
export const TAGS: readonly TagDef[] = [
  ...
  { id: 'country-club', name: 'Country Club', blurb: 'Beautiful grounds, a long waiting list, and a lot of sailing.', why: 'A dear sticker, little aid, and a beautiful campus.', size: -0.05, quality: 2, teeth: { lever: 'giving', amount: 0.15, line: 'Old boys write checks: fifteen percent more giving each year.' } },
