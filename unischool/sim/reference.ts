...
export const REFERENCE: Reference = {
  "Balanced builder": [
    { year: 5, cash: { lo: 461969.5462, hi: 5222997.2409 }, enrolled: { lo: 1560, hi: 2700 }, prestige: { lo: 46.2054, hi: 84.6279 }, rank: { lo: 35.25, hi: 66.25 }, netMargin: { lo: 0.1414, hi: 0.4156 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 6887586.4657, hi: 29455508.7346 }, enrolled: { lo: 7990.5, hi: 15035 }, prestige: { lo: 56.868, hi: 103.1747 }, rank: { lo: 15, hi: 40 }, netMargin: { lo: 0.1306, hi: 0.4093 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 24549381.5569, hi: 77380502.7587 }, enrolled: { lo: 17760, hi: 36100 }, prestige: { lo: 100.578, hi: 174.6682 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0327, hi: 0.1579 }, weeksInTheRed: { lo: 0, hi: 146.25 } },
    { year: 35, cash: { lo: 60116591.5229, hi: 401334294.9719 }, enrolled: { lo: 23400, hi: 41900 }, prestige: { lo: 112.0757, hi: 187.1285 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: 0.0029, hi: 0.1106 }, weeksInTheRed: { lo: 0, hi: 146.25 } },
    { year: 50, cash: { lo: 72822242.2397, hi: 1997114548.8589 }, enrolled: { lo: 25140, hi: 41900 }, prestige: { lo: 112.4877, hi: 187.4892 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0089, hi: 0.5738 }, weeksInTheRed: { lo: 0, hi: 146.25 } },
  ],
  "Curriculum rush (overreach)": [
    { year: 5, cash: { lo: -756136.166, hi: 1363517.2297 }, enrolled: { lo: 526.5, hi: 1038.75 }, prestige: { lo: 31.6804, hi: 54.7602 }, rank: { lo: 43.5, hi: 73.75 }, netMargin: { lo: -0.0896, hi: 0.0565 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: -1598558.8718, hi: 1676745.2609 }, enrolled: { lo: 533.25, hi: 1133.75 }, prestige: { lo: 34.8801, hi: 59.8937 }, rank: { lo: 42.75, hi: 73.75 }, netMargin: { lo: 0.016, hi: 0.158 }, weeksInTheRed: { lo: 22, hi: 251.25 } },
    { year: 20, cash: { lo: -966767.1619, hi: 3736842.3922 }, enrolled: { lo: 735, hi: 3090 }, prestige: { lo: 35.0119, hi: 71.3585 }, rank: { lo: 40.5, hi: 80 }, netMargin: { lo: -0.0008, hi: 0.5015 }, weeksInTheRed: { lo: 30, hi: 281.25 } },
    { year: 35, cash: { lo: 4014111.5421, hi: 80395847.6542 }, enrolled: { lo: 1672.5, hi: 40300 }, prestige: { lo: 39.2537, hi: 137.2584 }, rank: { lo: 3, hi: 78.75 }, netMargin: { lo: -0.0444, hi: 0.3767 }, weeksInTheRed: { lo: 30, hi: 281.25 } },
    { year: 50, cash: { lo: 16006975.3868, hi: 4921193399.4236 }, enrolled: { lo: 24480, hi: 41900 }, prestige: { lo: 98.2948, hi: 186.0455 }, rank: { lo: 1, hi: 5 }, netMargin: { lo: -0.0118, hi: 0.1745 }, weeksInTheRed: { lo: 31.5, hi: 281.25 } },
  ],
  "Discount volume (beds first)": [
    { year: 5, cash: { lo: -1702254.8536, hi: 483366.5009 }, enrolled: { lo: 420, hi: 700 }, prestige: { lo: 50.4739, hi: 84.1355 }, rank: { lo: 33, hi: 57.5 }, netMargin: { lo: -0.1347, hi: -0.0309 }, weeksInTheRed: { lo: 7, hi: 33 } },
    { year: 10, cash: { lo: -5215542.72, hi: -3061477.8096 }, enrolled: { lo: 420, hi: 700 }, prestige: { lo: 57.9384, hi: 96.568 }, rank: { lo: 20.25, hi: 37.5 }, netMargin: { lo: -0.0415, hi: 0.0639 }, weeksInTheRed: { lo: 207.75, hi: 353.75 } },
    { year: 20, cash: { lo: -4228290.1972, hi: -1487813.9837 }, enrolled: { lo: 420, hi: 700 }, prestige: { lo: 61.213, hi: 102.0222 }, rank: { lo: 16.5, hi: 37.5 }, netMargin: { lo: -0.0415, hi: 0.0638 }, weeksInTheRed: { lo: 597.75, hi: 1003.75 } },
    { year: 35, cash: { lo: -1243417.5254, hi: 2432100.1363 }, enrolled: { lo: 420, hi: 700 }, prestige: { lo: 61.5753, hi: 102.6256 }, rank: { lo: 21.75, hi: 38.75 }, netMargin: { lo: -0.0382, hi: 0.0777 }, weeksInTheRed: { lo: 1112.25, hi: 1971.25 } },
    { year: 50, cash: { lo: -667878.5548, hi: 2005478.6873 }, enrolled: { lo: 420, hi: 700 }, prestige: { lo: 61.6175, hi: 102.8216 }, rank: { lo: 20.25, hi: 41.25 }, netMargin: { lo: -0.0908, hi: 0.1148 }, weeksInTheRed: { lo: 1224.75, hi: 2378.75 } },
  ],
  "Completionist (build everything)": [
    { year: 5, cash: { lo: -78977.0374, hi: 3977641.1321 }, enrolled: { lo: 420, hi: 1500 }, prestige: { lo: 51.2826, hi: 87.1414 }, rank: { lo: 29.25, hi: 56.25 }, netMargin: { lo: -0.0858, hi: 0.1569 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: -1528938.857, hi: 6193176.6569 }, enrolled: { lo: 420, hi: 5400 }, prestige: { lo: 56.8968, hi: 103.7425 }, rank: { lo: 14.25, hi: 37.5 }, netMargin: { lo: -0.0309, hi: 0.3434 }, weeksInTheRed: { lo: 0, hi: 228.75 } },
    { year: 20, cash: { lo: -35682760.6346, hi: 2736854.9248 }, enrolled: { lo: 420, hi: 31600 }, prestige: { lo: 66.522, hi: 161.7722 }, rank: { lo: 1, hi: 21.25 }, netMargin: { lo: -0.0482, hi: 0.1036 }, weeksInTheRed: { lo: 0, hi: 356.25 } },
    { year: 35, cash: { lo: -1550032.1373, hi: 187577825.1621 }, enrolled: { lo: 420, hi: 41800 }, prestige: { lo: 64.7367, hi: 186.7552 }, rank: { lo: 1, hi: 31.25 }, netMargin: { lo: -0.0532, hi: 0.1007 }, weeksInTheRed: { lo: 66.75, hi: 356.25 } },
    { year: 50, cash: { lo: 559701.2414, hi: 1112416082.8045 }, enrolled: { lo: 420, hi: 42700 }, prestige: { lo: 64.8689, hi: 187.4784 }, rank: { lo: 1, hi: 27.5 }, netMargin: { lo: -0.0594, hi: 0.2794 }, weeksInTheRed: { lo: 90, hi: 356.25 } },
  ],
  "Overbuilder (beds ahead of demand)": [
    { year: 5, cash: { lo: -1632055.7726, hi: 1380067.1505 }, enrolled: { lo: 664.5, hi: 1215 }, prestige: { lo: 28.8577, hi: 50.2411 }, rank: { lo: 48.75, hi: 83.75 }, netMargin: { lo: -0.1812, hi: 0.0719 }, weeksInTheRed: { lo: 0, hi: 66.25 } },
    { year: 10, cash: { lo: -5047558.8094, hi: -965089.1241 }, enrolled: { lo: 522.75, hi: 1052.5 }, prestige: { lo: 28.3398, hi: 50.6571 }, rank: { lo: 49.5, hi: 86.25 }, netMargin: { lo: -0.1236, hi: 0.0209 }, weeksInTheRed: { lo: 185.25, hi: 391.25 } },
    { year: 20, cash: { lo: -13830691.8961, hi: -1704260.4678 }, enrolled: { lo: 530.25, hi: 1123.75 }, prestige: { lo: 28.6164, hi: 51.3852 }, rank: { lo: 49.5, hi: 85 }, netMargin: { lo: -0.1256, hi: 0.0614 }, weeksInTheRed: { lo: 575.25, hi: 1041.25 } },
    { year: 35, cash: { lo: -24901921.245, hi: 822347.0135 }, enrolled: { lo: 537, hi: 1141.25 }, prestige: { lo: 28.7424, hi: 51.5907 }, rank: { lo: 51.75, hi: 91.25 }, netMargin: { lo: -0.1139, hi: 0.0751 }, weeksInTheRed: { lo: 1160.25, hi: 2016.25 } },
    { year: 50, cash: { lo: -34762850.5981, hi: 1579957.2876 }, enrolled: { lo: 528.75, hi: 1177.5 }, prestige: { lo: 28.556, hi: 51.317 }, rank: { lo: 54, hi: 95 }, netMargin: { lo: -0.1055, hi: 0.0309 }, weeksInTheRed: { lo: 1628.25, hi: 2991.25 } },
  ],
  "Earnest completionist": [
    { year: 5, cash: { lo: 1199699.2147, hi: 3932077.8363 }, enrolled: { lo: 2280, hi: 5212.5 }, prestige: { lo: 46.3053, hi: 79.3548 }, rank: { lo: 37.5, hi: 67.5 }, netMargin: { lo: 0.2746, hi: 0.6238 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 14466510.2692, hi: 29139925.3164 }, enrolled: { lo: 11040, hi: 23900 }, prestige: { lo: 64.5621, hi: 114.9702 }, rank: { lo: 7, hi: 25 }, netMargin: { lo: 0.0788, hi: 0.1967 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 15043785.1608, hi: 103159190.5749 }, enrolled: { lo: 12660, hi: 38900 }, prestige: { lo: 101.4489, hi: 179.6413 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0098, hi: 0.1198 }, weeksInTheRed: { lo: 0, hi: 305 } },
    { year: 35, cash: { lo: 202442532.9062, hi: 1036319149.5138 }, enrolled: { lo: 25140, hi: 42300 }, prestige: { lo: 111.6714, hi: 187.2725 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: 0.0083, hi: 0.2516 }, weeksInTheRed: { lo: 0, hi: 305 } },
    { year: 50, cash: { lo: 961177172.9391, hi: 3185666839.2716 }, enrolled: { lo: 25140, hi: 42300 }, prestige: { lo: 112.476, hi: 187.4934 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: 0.1987, hi: 0.9081 }, weeksInTheRed: { lo: 0, hi: 305 } },
  ],
  "Scatterer (founds anything anywhere)": [
    { year: 5, cash: { lo: 2142729.4941, hi: 7200933.7422 }, enrolled: { lo: 2100, hi: 3783.75 }, prestige: { lo: 45.4069, hi: 79.5108 }, rank: { lo: 38.25, hi: 65 }, netMargin: { lo: 0.1899, hi: 0.461 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 7919652.7279, hi: 30174622.354 }, enrolled: { lo: 8760, hi: 17696.25 }, prestige: { lo: 54.5001, hi: 95.5174 }, rank: { lo: 21, hi: 51.25 }, netMargin: { lo: 0.1298, hi: 0.3657 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 45177608.7578, hi: 166256429.5067 }, enrolled: { lo: 20580, hi: 34300 }, prestige: { lo: 77.2999, hi: 137.907 }, rank: { lo: 1, hi: 8 }, netMargin: { lo: -0.004, hi: 0.1178 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 35, cash: { lo: 174870981.7712, hi: 541505277.4891 }, enrolled: { lo: 20580, hi: 34700 }, prestige: { lo: 83.5171, hi: 148.564 }, rank: { lo: 1, hi: 7 }, netMargin: { lo: 0.0511, hi: 0.2119 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 50, cash: { lo: 472730845.4371, hi: 1515185580.2925 }, enrolled: { lo: 20580, hi: 34700 }, prestige: { lo: 84.9765, hi: 151.405 }, rank: { lo: 1, hi: 8 }, netMargin: { lo: 0.1355, hi: 0.3723 }, weeksInTheRed: { lo: 0, hi: 10 } },
  ],
  "Selective college": [
    { year: 5, cash: { lo: 165574.5751, hi: 3364108.2399 }, enrolled: { lo: 808.5, hi: 1446.25 }, prestige: { lo: 50.048, hi: 86.3383 }, rank: { lo: 31.5, hi: 56.25 }, netMargin: { lo: 0.3931, hi: 0.7458 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 4531852.0071, hi: 13869479.1335 }, enrolled: { lo: 2960.25, hi: 5277.5 }, prestige: { lo: 61.0457, hi: 104.5014 }, rank: { lo: 15.75, hi: 30 }, netMargin: { lo: 0.2226, hi: 0.7339 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 4952376.7312, hi: 71655379.7882 }, enrolled: { lo: 3123.75, hi: 5373.75 }, prestige: { lo: 105.2373, hi: 178.1042 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0774, hi: 0.0485 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 35, cash: { lo: 54391924.8681, hi: 285792339.148 }, enrolled: { lo: 3001.5, hi: 5020 }, prestige: { lo: 112.2897, hi: 187.228 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: 0.1697, hi: 0.3921 }, weeksInTheRed: { lo: 0, hi: 358.75 } },
    { year: 50, cash: { lo: 62378091.7399, hi: 923070312.021 }, enrolled: { lo: 2997.75, hi: 5005 }, prestige: { lo: 112.4939, hi: 187.4921 }, rank: { lo: 1, hi: 5 }, netMargin: { lo: 0.4153, hi: 0.9207 }, weeksInTheRed: { lo: 0, hi: 358.75 } },
  ],
  "Regional engine": [
    { year: 5, cash: { lo: 3806907.1921, hi: 7042242.196 }, enrolled: { lo: 1740, hi: 3200 }, prestige: { lo: 48.1346, hi: 82.3535 }, rank: { lo: 37.5, hi: 63.75 }, netMargin: { lo: 0.2117, hi: 0.4096 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 9369762.6216, hi: 27625247.1225 }, enrolled: { lo: 8580, hi: 21600 }, prestige: { lo: 61.3906, hi: 106.4653 }, rank: { lo: 12.75, hi: 28.75 }, netMargin: { lo: 0.1157, hi: 0.2346 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 24255336.9518, hi: 71389067.8491 }, enrolled: { lo: 21060, hi: 38300 }, prestige: { lo: 100.3651, hi: 176.3608 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0611, hi: 0.052 }, weeksInTheRed: { lo: 0, hi: 182.5 } },
    { year: 35, cash: { lo: 36413656.6929, hi: 122601504.1921 }, enrolled: { lo: 24000, hi: 41400 }, prestige: { lo: 112.0381, hi: 187.1775 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.0496, hi: 0.0703 }, weeksInTheRed: { lo: 0, hi: 183.75 } },
    { year: 50, cash: { lo: -7069727.4296, hi: 132776160.112 }, enrolled: { lo: 24840, hi: 41700 }, prestige: { lo: 112.4866, hi: 187.4907 }, rank: { lo: 1, hi: 4 }, netMargin: { lo: -0.033, hi: 0.0822 }, weeksInTheRed: { lo: 0, hi: 215 } },
  ],
  "Idle (builds nothing)": [
    { year: 5, cash: { lo: 4514572.838, hi: 7962055.5633 }, enrolled: { lo: 311.25, hi: 518.75 }, prestige: { lo: 30.5246, hi: 50.8743 }, rank: { lo: 46.5, hi: 80 }, netMargin: { lo: 0.0649, hi: 0.1649 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 10, cash: { lo: 5836701.9147, hi: 10403975.5786 }, enrolled: { lo: 339, hi: 565 }, prestige: { lo: 30.6314, hi: 51.0752 }, rank: { lo: 46.5, hi: 83.75 }, netMargin: { lo: 0.011, hi: 0.1114 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 20, cash: { lo: 9098479.8848, hi: 15966918.3383 }, enrolled: { lo: 338.25, hi: 563.75 }, prestige: { lo: 31.117, hi: 51.8943 }, rank: { lo: 50.25, hi: 86.25 }, netMargin: { lo: 0.0334, hi: 0.1415 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 35, cash: { lo: 15740221.077, hi: 28359307.0844 }, enrolled: { lo: 339, hi: 565 }, prestige: { lo: 31.3557, hi: 52.3914 }, rank: { lo: 54, hi: 92.5 }, netMargin: { lo: 0.0749, hi: 0.1938 }, weeksInTheRed: { lo: 0, hi: 10 } },
    { year: 50, cash: { lo: 25448467.4856, hi: 47138035.0538 }, enrolled: { lo: 339.75, hi: 566.25 }, prestige: { lo: 31.5972, hi: 52.9116 }, rank: { lo: 53.25, hi: 93.75 }, netMargin: { lo: 0.1262, hi: 0.2615 }, weeksInTheRed: { lo: 0, hi: 10 } },
  ],
};
// --- END GENERATED ---
