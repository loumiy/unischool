...
| 43 | [The consistency review](43-consistency-review.md) | The owner's request for a review of everything but the balance: the logic, the flow, the screens and the data, each read against the code, fixed where there was one right answer ([the review](../reviews/2026-09-consistency-review.md) lists every finding and the questions left open). The map and the words are Plans 44 and 45. One PR. | In progress |
