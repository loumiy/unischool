...
| 31 | [The world](31-the-world.md) | Phase J of the merge: how the world reads. Building condition as a prestige input, six standings in the league (in History), identity tags earned and shed over years that shape the pool and carry small teeth, one rival who is also the rival in the main sport, and a schedule that climbs with the college's name. PRs A–F. | In progress |
| 32 | [The events](32-the-events.md) | Phase K of the merge: v2's catalogue of events in place of this game's texture decisions. Inline events wait in a panel over the map and take their default if nobody answers; the rare seismic ones are the board's letters and stop the clock. One interpreter reads v2's conditions and applies its effects, with prices scaled to the college's budget, and seats answer their domain's routine. PRs A–E. | In progress |
| 33 | [Goals and the ending](33-goals-and-the-ending.md) | Phase L of the merge: promises with deadlines, rewards and penalties in place of the achievements, and a decade's list to choose from; capital projects that lift a standing, payable half from the endowment, with a late tier for the defend era; a summer without the Standing beat and a Review rebuilt; the chronicle; the Final Report in place of the legacy; the Epilogue; and the hall of fame. PRs A–I. | In progress |
