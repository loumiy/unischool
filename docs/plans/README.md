...
| 21 | [The department](21-the-department.md) | Athletics re-aimed rather than re-imagined: the name pools, outlets for the outputs that terminate in readings, a per-sport scale and a drag-and-drop priority list so the department has something to decide, a coach market scarce in good coaches rather than in coaches, four dated occasions a year, an arrival that stops being a coin flip, a postseason ban, and water polo. Six phases, PRs A–R. | Proposed |
