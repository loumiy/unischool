...
| 63 | [The archetypes and the report](63-archetypes.md) | The harness rebuild's last layers: Completionist, Selective, Lean and Idle as policies over the moves, checked for what must hold (slow, ~110 s); `npm run sim` reports their trajectories and the guided player's against a committed baseline; the old scripted-strategy sim, its bands and its reports go. One PR. | Landed |
| 64 | [The screenshots](64-screenshots.md) | Every image in `docs/images` and the README re-shot on the current game, each in a different one of the eight school colour pairs; a README section for the four other architectures; the scenario, layout and shot tools brought up to date (`--colors`, the projects' court, the Students tab). One PR. | Landed |
| 65 | [The natural line of play](65-natural-play.md) | The owner's natural line of play as a harness player (satisfaction under 100, programs broad then deep, schools sorted at seven halls, every varsity petition, the deepest safe initiative, price short of the red tier, spend to zero) and `npm run natural`, a year-by-year report of one run (`docs/reviews/2026-09-natural-play.md`); a school split over two halls merged when another has nowhere to go. One PR. | Landed |
| 66 | [Pacing targets and the scorecard](66-pacing.md) | The natural player should reach its ceilings around year 40, not 12: targets for enrollment, prestige, rank and weekly net (when each gets there, checkpoints at years 10–50, steadiness, a buffer for the guided player), and `npm run natural -- --pacing`, a three-seed scorecard against them. Baseline 14 of 50; the levers for the tuning plan. One PR. | Landed |
| 67 | [Pacing the natural line to forty years](67-pacing-tuning.md) | Tuning to Plan 66's targets, 14 → 45 of 50: the summer prestige climb capped at 2.0 points; the applicant pool a straight line in prestige, not a steep logistic; beds throttle only the founding years; a flatter price tolerance (and founding price); the rival field rising to a ceiling of 138. The natural line now reaches its ceilings around year 40, #1 at 35. Players pricing at "fair" still fill the catalogue's seats by about year 25. One PR. | Landed |
| 68 | [Pacing the catalogue for every player](68-catalogue-pacing.md) | The scorecard grows to three players (natural, guided, Completionist) and the catalogue: 59 → 86 of 111. New majors come at a pace (nine at once, then one every 54 weeks), offers finish one school at a time, a curriculum committee writes four courses at once, and the gym opens behind the health center. Every player's catalogue now fills over about thirty years, and the fair-price players' seats by year 35–40, not 17–20. One PR. | Landed |
| 69 | [Earlier schools, and everything built by year 50](69-sorting-and-completion.md) | The owner's answers to Plan 68: the natural line sorts its schools at four halls, not seven (first school at year 3, not 13); the fair-price players' flat net is watched, not counted, as long as every player is #1 and has built everything by year 50, two new scorecard rows. The guided player's money sense (a 3-week reserve, research only above 5 weeks, a faculty search when nobody is listed) lets it finish by year 37. 96 of 111. One PR. | Landed |
| 70 | [The launch](70-launch.md) | What stands between `main` and a public release, from the pre-launch survey and the owner's answers: saves that survive updates (migrations from launch, export/import); debug stripped from production, a crash screen, credits and meta tags; an endowment sweep with the board's nudge and grants cut to about 2× their cost; the merge review's leftovers; full touch support; sound and motion for every silent moment; text variants; play again and a shareable report card; PostHog analytics; the owner's playtest and 1.0. PRs A–L. | Proposed |
| 71 | [Money paces the first half; teaching earns the top](71-economy.md) | The owner's asks from a playthrough: offers two from started schools and one new; no allowance on majors, the committee shown with a seat more at prestige 70–100; dearer courses (a price that grows 0.3% with each course on offer), halls and labs, longer builds, an applicant trickle, overcrowding and overpricing shrink the pool; academic satisfaction is teaching against a standard that rises with the students, and a teaching ceiling on prestige: building everything reaches about #16, hand-picked faculty #1. Harness players tend teaching and relieve crowding; the allowance's scorecard rows reset per price. 76 of 114. One PR. | Landed |
